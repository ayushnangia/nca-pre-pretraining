#!/bin/bash
# ============================================================
# One-time environment setup for Fir (H100)
# Run on login node: bash scripts/fir/setup_env.sh
# ============================================================
...
echo "=== Setting up NCA pre-pre-training environment on Fir ==="
...
pip install tiktoken fire simplejson math-verify numba
