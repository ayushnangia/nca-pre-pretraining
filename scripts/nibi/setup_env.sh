#!/bin/bash
# ============================================================
# One-time environment setup for Nibi (H100)
# Run on login node: bash scripts/nibi/setup_env.sh
# ============================================================
...
echo "=== Setting up NCA pre-pre-training environment on Nibi ==="
...
pip install tiktoken nibie simplejson math-verify numba
