#!/bin/bash
# ============================================================
# One-time environment setup for Killarney (H100)
# Run this on a login node: bash scripts/killarney/setup_env.sh
# ============================================================
...
echo "=== Setting up NCA pre-pre-training environment on Killarney ==="
